...
bool isinVector(vector<int> nums, int aim);

void makeUnique(vector<int> original, vector<int>& result);

vector<int> fillVectFromFile();

void outputFile(vector<int> read_nums);
 ...
 */
bool isinVector(vector<int> read_nums, int aim) {
 ...
 */
void makeUnique(vector<int> original, vector<int>& unique) {
